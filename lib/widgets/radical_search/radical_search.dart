...
const Map<int, List<String>> radicalList = {
  1: ["一", "｜", "丶", "ノ", "乙", "亅"],
...
List<String> searchKanjiByRadicals(List<String> radicals) {
  return kanjis.entries
      .where((entry) {
...
List<String> getValidRadicals(List<String> kanjiResults) {
  return kanjiResults
      .map((kanji) => kanjis[kanji]!)
      .toList()
      .flattened
      .toSet()
      .toList();
